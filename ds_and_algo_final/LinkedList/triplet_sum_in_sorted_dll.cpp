...
int pair_sum(Node* first , Node* last , int x , int &a , int &b){
...
int triple_sum(Node* head , int x){
	...
	while(curr){
		...
		flag= pair_sum(curr->next , last , x-curr->data , a , b);
		cnt+= flag; 
		debug(a , b , x-curr->data , x , flag);
